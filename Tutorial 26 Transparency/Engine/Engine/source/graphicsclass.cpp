...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model1->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/map01.tga", "../Engine/data/square.txt");
	if(!result)
	{
	...
	result = m_Model2->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/stone01.tga", "../Engine/data/square.txt");
	if(!result)
	{
